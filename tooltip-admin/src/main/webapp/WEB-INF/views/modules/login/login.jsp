...
<head>
    ...
    <!--[if lte IE 9]>
    <link rel="stylesheet" href="${ctxStatic}/ace/assets/css/ace-part2.css"/>
    <![endif]-->
    <link rel="stylesheet" href="${ctxStatic}/ace/assets/css/ace-rtl.css"/>

    <!--[if lte IE 9]>
    <link rel="stylesheet" href="${ctxStatic}/ace/assets/css/ace-ie.css"/>
    <![endif]-->

    <!-- HTML5 shim and Respond.js IE8 support of HTML5 elements and media queries -->

    <!--[if lt IE 9]>
    <script src="${ctxStatic}/ace/assets/js/html5shiv.js"></script>
                ...
                <div class="login-container">
                    <div class="center">
                        <h1>
                            ...
                            <span class="red">${fns:getCompany()}</span>
                            <span class="white" id="id-text2">${fns:getProductName()}</span>
                        </h1>
                        <h4 class="blue" id="id-company-text">&copy; ${fns:getProductName()}</h4>
                    </div>
...
<script type="text/javascript" src="${ctxStatic}/js/core/jquery.cms.validate.js"></script>
