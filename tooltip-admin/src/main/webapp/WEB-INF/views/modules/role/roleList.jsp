...
<html>
	<head>
		...
		<meta name="menu" content="${ctx}/role/list" />
	</head>
            ...
            $(document).ready(function(){
                var contentTable = $('#contentTabel')
                        .dataTable( {
                            ...
                            "ajax":{
                                "url" : "${ctx}/role/datatables",//给服务器发请求的url
                                "type" : "post",
                                "data" :{
                                    "label":$("#label").val(),
                                    "type":$("#type").val(),
                            ...
                            "columnDefs":[
                                {
                                    ...
                                    "mRender": function(data, type, full) { // 返回自定义内容
                                        ...
                                        html += "<a title='修改' data-rel='tooltip' class='green' href='${ctx}/role/form?id=" + data + "' ><i class='ace-icon fa fa-pencil-square-o bigger-130'></i></a>";
                                        html += "<a title='删除' data-rel='tooltip' class='red' href='${ctx}/role/delete?id=" + data + "' onclick='return confirmx(\"删除吗?\",this.href)'><i class='ace-icon fa fa-trash-o bigger-130'></i></a>";
                                        html += "</div>";
                                        return html;
                                    }
        ...
        <div class="widget-box" style="margin:0px 0px 6px 0px;">
            <div class="widget-body">
                <div class="widget-main">
                    <form class="form-search" id="searchForm" action="${ctx}/role/list" method="post">
                        <div class="row">
