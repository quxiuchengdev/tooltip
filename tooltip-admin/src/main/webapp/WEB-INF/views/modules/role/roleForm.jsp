...
<html>
	...
	<body>
        ...
        function refreshTree(){
            var roleId = $("#id").val();
            $.post("${ctx}/role/treeview",{roleId:roleId}, function(result){
		...
		<div class="tabbable">
			<ul class="nav nav-tabs">
				...
				<li class="active">
					<a href="${ctx}/role/form?id=${role.id}">
						角色添加
					</a>
				</li>
			</ul>
		...
		<div class="widget-box" style="margin:0px 0px 6px 0px;">
			<div class="widget-body">
				<div class="widget-main">
					<form:form id="inputForm" modelAttribute="role" action="${ctx}/role/save" method="post" class="form-horizontal" >
						<!-- ID -->
